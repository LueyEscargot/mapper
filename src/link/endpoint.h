...
public:
    ...
    static bool appendPacketToSendList(Endpoint_t *pe, DynamicBuffer::BufBlk_t *pBufBlk);
    static bool appendPacketListToSendList(Endpoint_t *pe, DynamicBuffer::BufBlk_t *pBufBlkListHead);
